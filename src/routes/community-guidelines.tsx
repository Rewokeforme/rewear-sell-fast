...
export const Route = createFileRoute("/community-guidelines")({
  head: () => ({
    meta: [
      { title: "Communityregler — ReWoke" },
      { name: "description", content: "Reglerna som håller ReWoke tryggt, ärligt och välkomnande." },
      { property: "og:title", content: "Communityregler — ReWoke" },
...
function CommunityPage() {
  return (
    <PolicyPage
      ...
      intro="ReWoke är en plats för stilälskande svenskar som tror på cirkulär mode. Reglerna nedan håller upplevelsen trygg och välkomnande för alla."
      ...
      sections={[
        ...
        { title: "Förbjudet beteende", body: <ul><li>Bedrägeriförsök eller försök att flytta affären utanför ReWoke</li><li>Spam, masskopiering eller kapade konton</li><li>Vilseledande information eller dolda avgifter</li></ul> },
