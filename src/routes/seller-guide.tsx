...
export const Route = createFileRoute("/seller-guide")({
  head: () => ({
    meta: [
      { title: "Säljarguide — ReWoke" },
      { name: "description", content: "Så skapar du en annons som säljer på ReWoke." },
      { property: "og:title", content: "Säljarguide — ReWoke" },
...
function SellerGuide() {
  return (
    <PolicyPage
      ...
      title="Säljarguide"
      intro="En bra annons säljer snabbare och till bättre pris. Så här lyckas du på ReWoke."
      ...
      sections={[
        ...
        { title: "Prissättning", body: <p>Kolla liknande annonser på ReWoke. Vår AI ger ett prisförslag baserat på märke och skick.</p> },
