...
export const Route = createFileRoute("/safety")({
  head: () => ({
    meta: [
      { title: "Säker handel på Rewear" },
      { name: "description", content: "Tips och rutiner som gör second hand-handel på Rewear tryggt." },
      { property: "og:title", content: "Säker handel på Rewear" },
      { property: "og:description", content: "Så handlar du tryggt på Rewear." },
    ],
  }),
...
function SafetyPage() {
  return (
    <PolicyPage
      ...
      sections={[
        { title: "Håll kommunikationen i Rewear", body: <p>Genom att chatta i appen får vi möjlighet att hjälpa till om något går fel. Affärer utanför Rewear sker på egen risk.</p> },
